...
import { Check, Lock, Clock, AlertOctagon, ArrowRight } from "lucide-react";
...
export default function PartnerDashboard() {
    ...
    // Grab EVERYTHING instantly from our real-time Redux store!
                    ...
                    {mounted && dbStep >= 3 && partnerStatus !== "APPROVED" && (
                        ...
                        >
                            {partnerStatus === "PENDING" && (
                                <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/50 rounded-4xl p-6 md:p-8 flex items-start md:items-center space-x-6 shadow-sm">
                                    <div className="w-14 h-14 shrink-0 bg-amber-100 dark:bg-amber-900/40 rounded-full flex items-center justify-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-amber-700 dark:text-amber-600/80 mt-1 text-sm md:text-base leading-relaxed">
                                            Our admin team is currently verifying your vehicle and identity documents. This usually takes 24-48 hours. We will notify you once approved!
                                        </p>
                                    </div>
                                </div>
                            )}
                                    ...
                                    <div className="flex items-start md:items-center space-x-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-red-700 dark:text-red-400/80 mt-1 text-sm md:text-base font-medium">
                                                Reason: <span className="text-red-900 dark:text-red-300 font-bold">{rejectReason || "Please review your submitted documents and try again."}</span>
                                            </p>
                                        </div>
                                    </div>
                                    <button
                                        onClick={() => router.push("/partner/onboarding/vehicle")}
                                        className="shrink-0 w-full md:w-auto bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-6 rounded-xl transition-colors flex items-center justify-center space-x-2"
                                    >
